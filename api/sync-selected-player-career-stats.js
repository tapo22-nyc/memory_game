...
function buildFlatStats(statsArray) {
  ...
  return {
    // ODI batting
    odi_bat_matches:      statNum(s, "odi", "batting", "m"),
    odi_bat_innings:      statNum(s, "odi", "batting", "inn"),
    ...
    odi_bat_100s:         statNum(s, "odi", "batting", "100s"),
    odi_bat_50s:          statNum(s, "odi", "batting", "50s"),
    odi_bat_4s:           statNum(s, "odi", "batting", "4s"),
    odi_bat_6s:           statNum(s, "odi", "batting", "6s"),
    // ODI bowling
    odi_bowl_matches:     statNum(s, "odi", "bowling", "m"),
    odi_bowl_innings:     statNum(s, "odi", "bowling", "inn"),
    ...
    // T20 batting
    t20_bat_matches:      statNum(s, "t20", "batting", "m"),
    t20_bat_innings:      statNum(s, "t20", "batting", "inn"),
    ...
    t20_bat_100s:         statNum(s, "t20", "batting", "100s"),
    t20_bat_50s:          statNum(s, "t20", "batting", "50s"),
    t20_bat_4s:           statNum(s, "t20", "batting", "4s"),
    t20_bat_6s:           statNum(s, "t20", "batting", "6s"),
    // T20 bowling
    t20_bowl_matches:     statNum(s, "t20", "bowling", "m"),
    t20_bowl_innings:     statNum(s, "t20", "bowling", "inn"),
    ...
    // Test batting
    test_bat_matches:     statNum(s, "test", "batting", "m"),
    test_bat_innings:     statNum(s, "test", "batting", "inn"),
    ...
    test_bat_100s:        statNum(s, "test", "batting", "100s"),
    test_bat_50s:         statNum(s, "test", "batting", "50s"),
    test_bat_4s:          statNum(s, "test", "batting", "4s"),
    test_bat_6s:          statNum(s, "test", "batting", "6s"),
    // Test bowling
    test_bowl_matches:    statNum(s, "test", "bowling", "m"),
    test_bowl_innings:    statNum(s, "test", "bowling", "inn"),
    ...
    test_bowl_10wi:       statNum(s, "test", "bowling", "10w"),
  };
}
