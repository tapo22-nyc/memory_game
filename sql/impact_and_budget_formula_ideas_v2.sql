-- ============================================================
-- FILE: impact_and_budget_formula_ideas_v2.sql
...
--
-- FIX vs v1:
--   JOIN condition now maps full country names to short codes
--   ('Sri Lanka' → 'SL', 'West Indies' → 'WI') so that
--   player_career_stats_master and cricket_player_pool join correctly.
-- ============================================================
...
-- No JOIN needed — reads directly from player_career_stats_master.
-- ────────────────────────────────────────────────────────────
...
--
-- NOTE: player_career_stats_master stores full country names
-- ('Sri Lanka', 'West Indies') but cricket_player_pool stores
-- short codes ('SL', 'WI') — the CASE handles this mapping.
-- ────────────────────────────────────────────────────────────
...
--   Wanindu Hasaranga (SL) → should rank high on bowling
